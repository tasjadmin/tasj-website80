    ...
    >
      <div className="card-image">
        <img
          ...
          height="120"
          onError={(e) => {
            e.target.src = 'https://via.placeholder.com/300x300/1A237E/FFFFFF?text=' + leader.name.split(' ')[0];
          }}
        />
      </div>
      ...
      <div className="card-content">
        ...
        <p className="member-description">{leader.description}</p>
      </div>
      ...
      <div className="social-links">
        {leader.social && Object.entries(leader.social).map(([platform, url]) => (
          <button
            ...
            onClick={() => handleSocialClick(platform === 'email' ? `mailto:${url}` : url)}
